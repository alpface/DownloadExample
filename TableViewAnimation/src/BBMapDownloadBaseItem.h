...
@interface BBMapDownloadTableViewCellArrtibuted : NSObject

@property (nonatomic, copy) NSAttributedString *stateTitle;
@property (nonatomic, strong) NSArray *actionMenuTitles;
@property (nonatomic, strong) UIImage *navStateImage;
@property (nonatomic, strong) UIImage *tourStateImage;

@end

@interface BBMapDownloadTableViewCellModel : BBMapDownloadBaseItem

@property (nonatomic, assign, readonly) SEL longPressGestureActionSel;
...
- (instancetype)initWithHeight:(CGFloat)height
              ...
              longPressGesture:(SEL)longPressGestureActionSel
                     cellClass:(Class)cellClass
                         model:(id)model;
/// 显示的状态文本
- (BBMapDownloadTableViewCellArrtibuted *)getAttributed;
